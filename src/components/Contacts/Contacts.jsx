...
const Contacts = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_p753xsd", "template_5y9xq2j", form.current, {
        publicKey: "6_durFarLizJjs7LF",
      })
      .then(
        () => {
          console.log("SUCCESS!");
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white mt-20 mb-20">
      ...
      <div className="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
        <div className="bg-blue-900 rounded-lg p-6 max-lg:text-center h-full">
          ...
          <ul className="mt-16 space-y-10">
            ...
            <li className="flex items-center max-lg:justify-center">
              ...
              <a href="javascript:void(0)" className="text-white text-sm ml-3">
                <p>22 Woodlands Walk, Singapore 738390</p>
              </a>
            </li>
          </ul>
        </div>
        <div className="p-6 rounded-xl lg:col-span-2">
          <form ref={form} onSubmit={sendEmail}>
            <div className="grid sm:grid-cols-2 gap-8 ">
              ...
              <div className="relative flex items-center sm:col-span-2 mb-5">
                <textarea
            ...
            <button
              type="submit"
              value="Send"
              className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-blue-900 text-white hover:bg-blue-800"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16px"
